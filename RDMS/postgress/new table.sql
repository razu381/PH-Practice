...
('Bob','Johnson',21,'B+','Chemistry',null,'2003-07-22','A-','Canada'),
('Charlie','Brown',20,'A+','Computer Science','charlie.b@example.com','2004-11-01','B+','UK'),
('Diana','Miller',18,'B','Literature',null,'2006-01-28','AB-','Australia'),
...
--we can combine both scaler and aggregrate functions 
select max(length(firstname)) from students age

select * from students
    WHERE email is not NULL

select COALESCE(email, 'mail not provided')  from students

select * from students
    where country = 'USA' or country = 'Canada' or country = 'Turkey'

SELECT * FROM students
    WHERE country IN('USA','Canada','Turkey')

SELECT * FROM students
    WHERE dob BETWEEN '2001-01-01' and '2002-12-01' ORDER BY dob ASC
...
UPDATE students
    set email = 'dontknow@gmail.com'
    where student_id=22

DELETE from students
    WHERE email='notknownyet@gmail.com'